...
#define print_inval_opt(prefix, opt) (eprintf("%s: invalid option -- '%c'\n", prefix, opt))
...
int directory_comp(const void *, const void *);
int directory_comp_ignore_case(const void *, const void *);
int ignore_case_cmp(const void *, const void *);
...
int numcmp_base(double d1, double d2)
{
	if (d1 > d2)
		return 1;
	if (d1 == d2)
...
int ignore_case_cmp(const void *p1, const void *p2)
{
	const char *s1 = *(const char **) p1;
	const char *s2 = *(const char **) p2;
	int result;
...
int directory_comp_base(const char *s1, const char *s2, bool fold)
{
	unsigned char c1;
	unsigned char c2;
...
int directory_comp_ignore_case(const void *p1, const void *p2)
{
	const char *s1 = *(const char **) p1;
	const char *s2 = *(const char **) p2;
	int result;
...
int directory_comp(const void *p1, const void *p2)
{
	const char *s1 = *(const char **) p1;
	const char *s2 = *(const char **) p2;
	int result;
