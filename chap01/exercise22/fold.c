...
int main()
{
	char buffer[MAXBUFFER]; /* buffer to keep character after a occurrence of a blank after a non-blank */
	int c;									/* input character */
	int w;                  /* index to write on buffer */
	int i;									/* index to iterate the buffer */
	int lastblank;          /* is there a blank after a non blank in this line ? TRUE : FALSE */
